      ...
      ?>
                    ...
                    <td>
                        <form action="" method="post">
                           ...
                           <button type="submit" class="fas fa-trash-alt fa-lg" name="delete" onclick="return confirm('delete this item?');"></button>
                           <div >
                              <input type="number" name="qty" class="qty" min="1" max="99" value="<?= $fetch_cart['quantity']; ?>" maxlength="2">
                              <button type="submit" class="fas fa-edit fa-lg" name="update_qty"></button>
                           </div>
...
<section class="products">
   ...
   <!-- <div class="cart-total">
      ...
      <a href="checkout3.php" class="btn <?= ($grand_total > 1)?'':'disabled'; ?>">proceed to checkout</a>
   </div> -->
